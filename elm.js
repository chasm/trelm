...
Elm.TestRunner.make = function (_elm) {
   ...
   var pageHeader = A2($Html.h1,_U.list([$Html$Attributes.id("logo")]),_U.list([A2(title,"Hello!",5)]));
   var view = A2($Html.div,_U.list([$Html$Attributes.id("container")]),_U.list([pageHeader,pageFooter]));
   var main = view;
   return _elm.TestRunner.values = {_op: _op,title: title,pageHeader: pageHeader,pageFooter: pageFooter,view: view,main: main};
};
