...
Elm.TestRunner.make = function (_elm) {
   ...
   var Test = F4(function (a,b,c,d) {    return {id: a,description: b,test: c,status: d};});
   ...
   var init = {ctor: "_Tuple2",_0: _U.list([]),_1: fetchTests};
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "SetTests": var newModel = A2($Maybe.withDefault,defaultModel,_p2._0);
